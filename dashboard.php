...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <!--<title>Channel Point | Dashboard</title>-->
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <!--<a href="index.php" class="logo"><span>Channel Point<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    -->
                </div>
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <!--<a href="../index.php">Channel Point</a>-->
                                        </li>
                                        <li>
                                           <!-- <a href="#">Admin</a>-->
                                        </li>
   ...
   <div class="row">
      ...
      <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Deleted News</p>
